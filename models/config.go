...
type DFPConfig struct {
	...
	ForceWashingDuration int `json:"force_washing_duration" validate:"required" gorm:"column:force_washing_duration;type:bigint"`
	...
	// WaitTimeBetweenWashing is the minimal time in minutes to wait before start a washing since last washing
	...
	WashingDuration int `json:"washing_duration" validate:"required" gorm:"column:washing_duration;type:bigint"`
	...
	Version int64 `json:"version" gorm:"column:version;type:bigint"`

	// UpdatedAt is the date of modification
